...
if (GOOGLE_CLIENT_ID && GOOGLE_CLIENT_ID !== 'placeholder' && GOOGLE_CLIENT_SECRET && GOOGLE_CLIENT_SECRET !== 'placeholder') {
  passport.use(
    new GoogleStrategy(
      {
  ...
  console.warn('[Auth] Google OAuth is disabled — GOOGLE_CLIENT_ID or GOOGLE_CLIENT_SECRET not configured.');
}
