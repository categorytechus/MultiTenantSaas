...
export default function SignInPage() {
  ...
  const googleAuthUrl = `${CONFIG.AUTH_API_URL}/auth/google${
    returnUrl ? `?returnUrl=${encodeURIComponent(returnUrl)}` : ''
  }`;
  const microsoftAuthUrl = `${CONFIG.AUTH_API_URL}/auth/microsoft${
    returnUrl ? `?returnUrl=${encodeURIComponent(returnUrl)}` : ''
  }`;
    ...
    <>
      ...
      <div className="page">
        <div className="wrap">
          ...
          <button className="g-btn" type="button" onClick={() => { window.location.href = googleAuthUrl; }}>
          ...
          <button className="g-btn" type="button" onClick={() => { window.location.href = microsoftAuthUrl; }}>
